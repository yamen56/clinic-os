...
export const statusColors: Record<StatusKey, { fg: string; bg: string }> = {
  ...
  danger: { fg: "var(--color-st-noshow)", bg: "var(--color-st-noshow-soft)" },
  neutral: { fg: "var(--color-ink-700)", bg: "var(--color-st-cancelled-soft)" },
  brand: { fg: "var(--color-brand-700)", bg: "var(--color-brand-50)" },
};
